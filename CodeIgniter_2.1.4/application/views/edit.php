<form id="meeting_edot" class="form-horizontal" role="form" method="post" action=<?php echo '"'.$base_url.'index.php/editmeeting/create"';?> enctype="multipart/form-data">
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="mdate" name="mdate" placeholder="请输入会议日期">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="start" name="start" placeholder="请输入会议开始时间">
		</div>
	</div>
	<div class="form-group">
		<label for="end" class="col-sm-2 control-label">结束时间</label>
		<div class="col-sm-10">
			<input type="text" class="form-control" id="end" name="end" placeholder="请输入会议结束时间">
		</div>
	</div>
